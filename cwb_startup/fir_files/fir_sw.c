...
// Declare IO ports using in and out keywords
// Separate pure SW version from synthesizable using pre-compiler directives #ifdefs
 ...
 *------------------------------------------------------  */
// Main top function to be synthesized
// Need to be declared as a process using this keyword
// Separate pure SW version from synthesizable using pre-compiler directives #ifdefs
